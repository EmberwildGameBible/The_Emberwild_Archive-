...
## Summary
Navigation for in-world documents—gazettes, rumor sheets, ledgers, and notices—so players and writers can trace leads without duplicating canon items or quests.

## Details
- Artifacts live in [09_Artifacts](../09_Artifacts) and reference global items, quests, and regions instead of re-stating them.
- Each entry below links to its source file plus the primary location it circulates through.
- Use the hooks to spot where artifacts can seed new quests or item drops without breaking single-source-of-truth rules.
...
| [Thousandfold Stock Freight Ledger](../09_Artifacts/Thousandfold_Stock_Freight_Ledger.md) | Emberford Marketwalk caravans | Freight tally noting missing reels, misrouted surplus, and glowspore-tainted fuel drums. Published. |
...
- [Ashlane Rumor Slip](../09_Artifacts/Ashlane_Rumor_Slip.md), [Beacon Chatter Rumor Slip](../09_Artifacts/Beacon_Chatter_Rumor_Slip.md)
...
- [Quarry Wink Rumor Slip](../09_Artifacts/Quarry_Wink_Rumor_Slip.md), [Rafter Rumor Slip](../09_Artifacts/Rafter_Rumor_Slip.md)
...
- [Ridgecrest Rumor Slip](../09_Artifacts/Ridgecrest_Rumor_Slip.md), [Rime Tug Rumor Slip](../09_Artifacts/Rime_Tug_Rumor_Slip.md)
...
- [Cratehook Record Ledger](../09_Artifacts/Cratehook_Record_Ledger.md), [Crownpost Ledger](../09_Artifacts/Crownpost_Ledger.md)
- [Drydock Log Ledger](../09_Artifacts/Drydock_Log_Ledger.md), [Ember Cart Ledger](../09_Artifacts/Ember_Cart_Ledger.md)
...
- [Grove Ledger](../09_Artifacts/Grove_Ledger.md), [Heatrun Log Ledger](../09_Artifacts/Heatrun_Log_Ledger.md)
...
- [Mirehaul Log Ledger](../09_Artifacts/Mirehaul_Log_Ledger.md), [Pikecarve Ledger](../09_Artifacts/Pikecarve_Ledger.md)
...
- [Shatterglass Oathkeeper Ledger](../09_Artifacts/Shatterglass_Oathkeeper_Ledger.md), [Shivercoil Ledger](../09_Artifacts/Shivercoil_Ledger.md)
...
- [Briar Permit](../09_Artifacts/Briar_Permit.md), [Burn Scar Freight Permit](../09_Artifacts/Burn_Scar_Freight_Permit.md)
- [Crest Permit](../09_Artifacts/Crest_Permit.md), [Emberford Scoria Fireglass Permit](../09_Artifacts/Emberford_Scoria_Fireglass_Permit.md)
...
- [Glimmer Permit](../09_Artifacts/Glimmer_Permit.md), [Glimmerdeep Chasm Salvage Permit](../09_Artifacts/Glimmerdeep_Chasm_Salvage_Permit.md)
...
- [Ridge Kiln Permit](../09_Artifacts/Ridge_Kiln_Permit.md), [Ridge Permit](../09_Artifacts/Ridge_Permit.md)
- [Rime Order Permit](../09_Artifacts/Rime_Order_Permit.md), [Salt Barge Order Permit](../09_Artifacts/Salt_Barge_Order_Permit.md)
- [Shard Delivery Order Permit](../09_Artifacts/Shard_Delivery_Order_Permit.md), [Sledge Permit](../09_Artifacts/Sledge_Permit.md)
- [Sooted Order Permit](../09_Artifacts/Sooted_Order_Permit.md), [Splice Permit](../09_Artifacts/Splice_Permit.md)
- [Switchback Permit](../09_Artifacts/Switchback_Permit.md), [Thornlash Banner Permit](../09_Artifacts/Thornlash_Banner_Permit.md)
...
- [Artifact Bundle 03](../09_Artifacts/Generated_Batches/2026-01-04_SIGMA_Greatwood_Whisperline/Artifact_Bundle_03.md) — bridge rail chips, tarred ribbons, IOU stubs, and hum logs deepening Whisperline routes.
...
## See also
- [MASTER_NAV](./MASTER_NAV.md) — top-level navigation to all indexes.
- [Regions_Index](./Regions_Index.md) — where to slot new artifacts tied to a locale.
- [Items_Index](./Items_Index.md) — canonical item definitions that artifacts should reference.
